...
function handleClearFilters(){
  ...
  return (
    <div className={styles.filters}>
        ...
        <select className={styles.AlphabeticalOrder} onChange={alphHandler} value={alph}>
        ...
        <select className={styles.DamageOrder} onChange={damageHandler} value={orderDamage}>
            <option value="order" disabled='disabled'>Order by</option>
            <option value="all">All</option>
        ...
        <select className={styles.FilterBy} onChange={handleFilter} value={type}>
